...
namespace RothschildHouse.Identity.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    private readonly SignInManager<RothschildHouseUser> _signInManager;
    ...
    public Callback(
        ...
        UserManager<RothschildHouseUser> userManager,
        SignInManager<RothschildHouseUser> signInManager)
    {
    ...
    private async Task<RothschildHouseUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
    {
        var sub = Guid.NewGuid().ToString();
            
        var user = new RothschildHouseUser
        {
            Id = sub,
